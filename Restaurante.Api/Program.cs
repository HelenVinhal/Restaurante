...
builder.Services.AddScoped<IAtualizarEmailUsuarioUseCase, AtualizarEmailUsuarioUseCase>();
builder.Services.AddScoped<IAtualizarSenhaUsuarioUseCase, AtualizarSenhaUsuarioUseCase>();
